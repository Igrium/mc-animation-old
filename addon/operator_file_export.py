...
bl_info = {
    "name": "MCAnimation",
    "description": "An addon that allows you to export animations onto Minecraft armor stands",
    "author": "Sam54123",
    "version": (0, 1, 0),
    "blender": (2, 7, 9),
    "wiki_url": "https://github.com/Sam54123/mc-animation",
    "tracker_url": "https://github.com/Sam54123/mc-animation/issues",
    "category": "Animation"
}

class ExportMCAnim(Operator, ExportHelper):
    ...
    def execute(self, context):
        return export(context, self.id, self.looping, self.filepath)
    
# specific export function for menu
def export(context, id, looping, path):
    return write_mcanim(context, context.scene.objects.active, int(id), looping, path)
...
def register():
    bpy.utils.register_class(ExportMCAnim)
    bpy.types.INFO_MT_file_export.append(menu_func_export)


def unregister():
    bpy.utils.unregister_class(ExportMCAnim)
